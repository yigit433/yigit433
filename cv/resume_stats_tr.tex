...
\section{Projeler}
\noindent\textbf{Kurumzeka --- Yapay zeka destekli kurumsal arama ve veri sınıflandırma sistemi} \hfill Python, PostgreSQL, Redis, Pandas\\
\begin{itemize}[leftmargin=*,noitemsep,topsep=2pt]
...
\noindent\textbf{\href{https://pickin.co}{Pickin} --- Gerçek zamanlı çekiliş platformu} \hfill Next.js, TypeScript, PostgreSQL\\
\begin{itemize}[leftmargin=*,noitemsep,topsep=2pt]
...
\noindent\textbf{\href{https://deckplane.com}{Deckplane} --- Dağıtık Docker yönetim platformu} \hfill Bun, Hono, TypeScript, PostgreSQL\\
\begin{itemize}[leftmargin=*,noitemsep,topsep=2pt]
