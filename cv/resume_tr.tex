...
\end{itemize}
\noindent\textbf{\href{https://github.com/yigit433/kommando}{kommando} — Go için CLI araç kiti} \hfill Go\\
\begin{itemize}[leftmargin=*,noitemsep,topsep=0pt]
...
\end{itemize}
\noindent\textbf{\href{https://github.com/yigit433/helper-tui}{helper-tui} — Terminal arayüzü yardımcısı} \hfill Rust\\
\begin{itemize}[leftmargin=*,noitemsep,topsep=0pt]
...
\end{itemize}
\noindent\textbf{\href{https://github.com/yigit433/feather-stream}{feather-stream} — Google Drive medya oynatıcı} \hfill Tauri, React, TypeScript\\
\begin{itemize}[leftmargin=*,noitemsep,topsep=0pt]
...
\end{itemize}
\noindent\textbf{\href{https://github.com/yigit433/jsonparser}{jsonparser} — C ile yazılmış JSON parser} \hfill C\\
\begin{itemize}[leftmargin=*,noitemsep,topsep=0pt]
